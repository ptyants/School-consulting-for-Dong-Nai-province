    ...
    messages: [
      {
        ...
        - Note that all questions with an educational context should be understood as related to "Sở Giáo dục & Đào tạo tỉnh Đồng Nai" (Sở GD&ĐT Đồng Nai). You must add Sở GD&ĐT Đồng Nai for the correct question. For example: "universities in the province" => "universities in Dong Nai province"
        - Conversation history: ${chat_history}
