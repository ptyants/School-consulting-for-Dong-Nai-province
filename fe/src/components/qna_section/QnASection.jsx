...
function Introduction() {
  return (
    <div className="w-3/5 mx-auto mb-6">
      <img src="https://i.fbcd.co/products/resized/resized-750-500/robotts-a965085232efd5afb23acf8624b0c85fc56a6f88ba043b23366248aa3849e46a.jpg" className="w-16 xl:w-20 sm:w-20 mb-4 mx-auto" />
