...
export default function createQnARenderer({ updateAudioURL, playAudio, pauseAudio, audioElement }) {
  return function renderQnA(response, index) {
    if(response.isLoading) {
      return (
        <QnAMessage avatar="https://i.fbcd.co/products/resized/resized-750-500/robotts-a965085232efd5afb23acf8624b0c85fc56a6f88ba043b23366248aa3849e46a.jpg" key={index}>
